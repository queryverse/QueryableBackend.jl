...
include("queryable/queryable_outerjoin.jl")
...
include("queryable/queryable_setops.jl")
include("queryable/queryable_partition.jl")
include("queryable/queryable_ordering.jl")
include("queryable/queryable_combining.jl")
include("queryable/queryable_keyedaggregation.jl")
include("queryable/queryable_typefiltering.jl")

include("source_queryable.jl")
include("query_tree.jl")
include("queryable/queryable_scalar.jl")
